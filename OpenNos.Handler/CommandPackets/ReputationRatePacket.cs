...
{
    [PacketHeader("$ReputationRate", PassNonParseablePacket = true, Authority = AuthorityType.GA)]
    public class ReputationRatePacket
    {
        #region Members
        ...
        public static void HandlePacket(object session, string packet)
        {
            if (session is ClientSession sess)
            {
                ...
                ReputationRatePacket packetDefinition = new ReputationRatePacket();
        ...
        public static void Register() => PacketFacility.AddHandler(typeof(ReputationRatePacket), HandlePacket, ReturnHelp);
        ...
        private void ExecuteHandler(ClientSession session)
        {
            if (_isParsed)
            {
                ...
                if (Value <= 1000)
                {
                    ServerManager.Instance.Configuration.RateReputation = Value;
                    session.SendPacket(
