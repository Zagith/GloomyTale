...
namespace GloomyTale.GameObject
{
    ...
    public class MapDesignObject : MinilandObjectDTO
    {
        ...
        {
            return $"mlobj {(deleted ? 0 : 1)} {ItemInstance.Slot} {MapX} {MapY} {ItemInstance.Item.Width} {ItemInstance.Item.Height} 0 {ItemInstance.DurabilityPoint} 0 {(ItemInstance.Item.ItemType == Domain.ItemType.House ? 1 : 0)}";
        }
