        ...
        public override void Use(ClientSession session, ref ItemInstance inv, byte Option = 0, string[] packetsplit = null)
        {
            ...
            switch (Effect)
            {
                ...
                case 11:
                    ...
                    {
                        Mate mate = session.Character.Mates.Find(s => s.MateTransportId == mateTransportId);
                        if (mate == null || mate.MateType != MateType.Pet || mate.Level >= session.Character.Level - 5 || mate.Level + 1 > 100)//ServerManager.Instance.Configuration.MaxLevel)
                        {
                            return;
                        }
                        mate.Level++;
                ...
                case 12:
                    ...
                    {
                        Mate mate = session.Character.Mates.Find(s => s.MateTransportId == mateTransportId);
                        if (mate == null || mate.MateType != MateType.Partner || mate.Level >= session.Character.Level - 5 || mate.Level + 1 > 100) //ServerManager.Instance.Configuration.MaxLevel)
                        {
                            return;
                        }
                        mate.Level++;
