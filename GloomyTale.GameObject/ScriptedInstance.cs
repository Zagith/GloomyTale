    ...
    public class ScriptedInstance : ScriptedInstanceDTO
    {
        ...
        private List<EventContainer> SummonMonster(MapInstance mapInstance, XMLModel.Events.SummonMonster[] summonMonster, bool isChildMonster = false)
        {
            ...
            if (summonMonster != null)
            {
                ...
                {
                    MonsterAmount++;
                    MonsterToSummon monster = new MonsterToSummon(summon.VNum, new MapCell { X = summon.PositionX, Y = summon.PositionY }, null, summon.Move, summon.IsTarget, summon.IsBonus, summon.IsHostile, summon.IsBoss);
                    ...
                    if (summon.OnNoticing != null)
                    {
                        ...
                        {
                            monster.NoticingEvents.Add(new EventContainer(mapInstance, EventActionType.EFFECT, new Tuple<short, int>(summon.OnNoticing.Effect.Value, summon.OnNoticing.Effect.Delay)));
                        }
                        ...
                        if (summon.OnNoticing.Move != null)
                        {
                            ...
                            {
                                events.Add(new EventContainer(mapInstance, EventActionType.EFFECT, new Tuple<short, int>(summon.OnNoticing.Move.Effect.Value, summon.OnNoticing.Move.Effect.Delay)));
                            }
