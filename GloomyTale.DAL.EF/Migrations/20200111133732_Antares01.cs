...
{
    public partial class Antares01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferrerId = table.Column<long>(nullable: false),
                    ...
                    DailyRewardSent = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BoxItemId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OriginalItemVNum = table.Column<short>(nullable: false),
                    OriginalItemDesign = table.Column<short>(nullable: false),
                    ItemGeneratedAmount = table.Column<short>(nullable: false),
                    ItemGeneratedVNum = table.Column<short>(nullable: false),
                    ItemGeneratedDesign = table.Column<short>(nullable: false),
                    ItemGeneratedRare = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CellonOptionId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EquipmentSerialId = table.Column<Guid>(nullable: false),
                    Level = table.Column<byte>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CellonOption", x => x.CellonOptionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastFactionChange = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    I18NShopNameId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Key = table.Column<string>(nullable: true),
                    RegionType = table.Column<int>(nullable: false),
                    Text = table.Column<string>(nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_I18NShopName", x => x.I18NShopNameId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHolder = table.Column<bool>(nullable: false),
                    IsMinilandObject = table.Column<bool>(nullable: false),
                    ...
                    SellToNpcPrice = table.Column<long>(nullable: false),
                    ...
                    SideReputation = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogPutItem", x => x.LogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceLog", x => x.LogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GridMapId = table.Column<short>(nullable: false),
                    Music = table.Column<int>(nullable: false),
                    Name = table.Column<string>(maxLength: 255, nullable: true),
                    ShopAllowed = table.Column<bool>(nullable: false),
                    XpRate = table.Column<byte>(nullable: false),
                    MeteoriteLevel = table.Column<int>(nullable: false),
                    Side = table.Column<int>(nullable: false),
                    GoldMapRate = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountRequired = table.Column<short>(nullable: false),
                    ...
                    Catch = table.Column<bool>(nullable: false),
                    CloseDefence = table.Column<short>(nullable: false),
                    Concentrate = table.Column<short>(nullable: false),
                    ...
                    DamageMaximum = table.Column<short>(nullable: false),
                    DamageMinimum = table.Column<short>(nullable: false),
                    DarkResistance = table.Column<int>(nullable: false),
                    DefenceDodge = table.Column<short>(nullable: false),
                    ...
                    Level = table.Column<byte>(nullable: false),
                    LightResistance = table.Column<int>(nullable: false),
                    MagicDefence = table.Column<short>(nullable: false),
                    ...
                    OriginalNpcMonsterVNum = table.Column<short>(nullable: false),
                    ...
                    MinLevelXP = table.Column<byte>(nullable: false),
                    MaxLevelXP = table.Column<byte>(nullable: false),
                    Contributi = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PartnerSkillId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EquipmentSerialId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerSkill", x => x.PartnerSkillId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DialogNpcVNum = table.Column<int>(nullable: true),
                    DialogNpcId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDaily = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QuestObjectiveId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuestId = table.Column<int>(nullable: false),
                    Data = table.Column<int>(nullable: true),
                    Objective = table.Column<int>(nullable: true),
                    SpecialData = table.Column<int>(nullable: true),
                    DropRate = table.Column<int>(nullable: true),
                    ObjectiveIndex = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShellEffectId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Effect = table.Column<byte>(nullable: false),
                    EffectLevel = table.Column<byte>(nullable: false),
                    EquipmentSerialId = table.Column<Guid>(nullable: false),
                    Value = table.Column<short>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShellEffect", x => x.ShellEffectId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LogId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharacterId = table.Column<long>(nullable: true),
                    TimeSpaceId = table.Column<long>(nullable: false),
                    Timestamp = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeSpacesLog", x => x.LogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemGeneratedVNum = table.Column<short>(nullable: false),
                    ItemGeneratedDesign = table.Column<short>(nullable: false),
                    MaximumOriginalItemRare = table.Column<byte>(nullable: false),
                    MinimumOriginalItemRare = table.Column<byte>(nullable: false),
                    OriginalItemDesign = table.Column<short>(nullable: false),
                    OriginalItemVNum = table.Column<short>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoldBank = table.Column<long>(nullable: false),
                    ...
                    IsPetAutoRelive = table.Column<bool>(nullable: false),
                    IsPartnerAutoRelive = table.Column<bool>(nullable: false),
                    ...
                    LastFamilyLeave = table.Column<long>(nullable: false),
                    Level = table.Column<byte>(nullable: false),
                    ...
                    MaxPartnerCount = table.Column<byte>(nullable: false),
                    ...
                    SecondPassword = table.Column<string>(nullable: true),
                    Contributi = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Side = table.Column<int>(nullable: false),
                    RequiredItem = table.Column<short>(nullable: false),
                    NomeOggetto = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestTimeSpaceId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapX = table.Column<short>(nullable: false),
                    MapY = table.Column<short>(nullable: false),
                    MonsterVNum = table.Column<short>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MapMonster_NpcMonster_MonsterVNum",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapY = table.Column<short>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    NpcVNum = table.Column<short>(nullable: false),
                    Position = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MapNpc_NpcMonster_NpcVNum",
                        column: x => x.NpcVNum,
                        principalTable: "NpcMonster",
                        principalColumn: "NpcMonsterVNum",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BCardId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CharacterTitleId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharacterId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterId = table.Column<long>(nullable: true),
                    IpAddress = table.Column<string>(maxLength: 255, nullable: true),
                    LogData = table.Column<string>(maxLength: 255, nullable: true),
                    LogType = table.Column<string>(nullable: true),
                    Timestamp = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralLog", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_GeneralLog_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GeneralLog_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LogId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharacterId = table.Column<long>(nullable: true),
                    ChatType = table.Column<byte>(nullable: false),
                    ChatMessage = table.Column<string>(maxLength: 255, nullable: true),
                    IpAddress = table.Column<string>(maxLength: 255, nullable: true),
                    Timestamp = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogChat", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_LogChat_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogCommands", x => x.CommandId);
                    table.ForeignKey(
                        name: "FK_LogCommands_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogDrop", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_LogDrop_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MailId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttachmentAmount = table.Column<short>(nullable: false),
                    AttachmentLevel = table.Column<byte>(nullable: false),
                    AttachmentRarity = table.Column<byte>(nullable: false),
                    AttachmentUpgrade = table.Column<byte>(nullable: false),
                    AttachmentDesign = table.Column<short>(nullable: false),
                    ...
                    SenderClass = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Mate_NpcMonster_NpcMonsterVNum",
                        column: x => x.NpcMonsterVNum,
                        principalTable: "NpcMonster",
                        principalColumn: "NpcMonsterVNum",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MinigameLogId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartTime = table.Column<long>(nullable: false),
                    EndTime = table.Column<long>(nullable: false),
                    Score = table.Column<int>(nullable: false),
                    Minigame = table.Column<byte>(nullable: false),
                    CharacterId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MinigameLog", x => x.MinigameLogId);
                    table.ForeignKey(
                        name: "FK_MinigameLog_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecipeListId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemVNum = table.Column<short>(nullable: true),
                    MapNpcId = table.Column<int>(nullable: true),
                    RecipeId = table.Column<short>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeList_Item_ItemVNum",
                        column: x => x.ItemVNum,
                        principalTable: "Item",
                        principalColumn: "VNum",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeList_MapNpc_MapNpcId",
                        column: x => x.MapNpcId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLevelPenalty = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MapTypeMap", x => x.MapTypeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TentaLaFortunaId = table.Column<short>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsRareRandom = table.Column<bool>(nullable: false),
                    Rare = table.Column<byte>(nullable: false),
                    Upgrade = table.Column<byte>(nullable: false),
                    ItemGeneratedAmount = table.Column<int>(nullable: false),
                    ItemGeneratedVNum = table.Column<short>(nullable: false),
                    Probability = table.Column<short>(nullable: false),
                    ShopId1 = table.Column<int>(nullable: true),
                    ShopId = table.Column<short>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FortuneWheel", x => x.TentaLaFortunaId);
                    table.ForeignKey(
                        name: "FK_FortuneWheel_Item_ItemGeneratedVNum",
                        column: x => x.ItemGeneratedVNum,
                        principalTable: "Item",
                        principalColumn: "VNum",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FortuneWheel_Shop_ShopId1",
                        column: x => x.ShopId1,
                        principalTable: "Shop",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FortuneWheel_ItemGeneratedVNum",
                table: "FortuneWheel",
                column: "ItemGeneratedVNum");

            migrationBuilder.CreateIndex(
                name: "IX_FortuneWheel_ShopId1",
                table: "FortuneWheel",
                column: "ShopId1");

            migrationBuilder.CreateIndex(
                name: "IX_GeneralLog_AccountId",
                table: "GeneralLog",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneralLog_CharacterId",
                table: "GeneralLog",
                column: "CharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogChat_CharacterId",
                table: "LogChat",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_LogCommands_CharacterId",
                table: "LogCommands",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_LogDrop_CharacterId",
                table: "LogDrop",
                column: "CharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MapMonster_MonsterVNum",
                table: "MapMonster",
                column: "MonsterVNum");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mate_NpcMonsterVNum",
                table: "Mate",
                column: "NpcMonsterVNum");

            migrationBuilder.CreateIndex(
                name: "IX_MinigameLog_CharacterId",
                table: "MinigameLog",
                column: "CharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeList_ItemVNum",
                table: "RecipeList",
                column: "ItemVNum");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeList_MapNpcId",
                table: "RecipeList",
                column: "MapNpcId");
