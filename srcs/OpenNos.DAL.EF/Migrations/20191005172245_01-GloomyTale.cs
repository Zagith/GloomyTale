...
{
    public partial class _01GloomyTale : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AntiBotLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterId = table.Column<long>(nullable: false),
                    CharacterName = table.Column<string>(nullable: true),
                    TargetAccountId = table.Column<long>(nullable: false),
                    TargetCharacterId = table.Column<long>(nullable: false),
                    TargetCharacterName = table.Column<string>(nullable: true),
                    ItemVnum = table.Column<short>(nullable: false),
                    ItemAmount = table.Column<short>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobLevel = table.Column<short>(nullable: false),
                    HeroLvl = table.Column<short>(nullable: false),
                    Vnum = table.Column<short>(nullable: false),
                    Amount = table.Column<short>(nullable: false),
                    IsMate = table.Column<bool>(nullable: false),
                    MateLevel = table.Column<short>(nullable: false),
                    MateType = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LevelUpRewards", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RaidLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterId = table.Column<long>(nullable: false),
                    CharacterName = table.Column<string>(nullable: true),
                    UpgradeType = table.Column<string>(nullable: true),
                    HasAmulet = table.Column<bool>(nullable: true),
                    Date = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpgradeLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterHome", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharacterHome_Character_CharacterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerSkill1 = table.Column<short>(nullable: false),
                    PartnerSkill2 = table.Column<short>(nullable: false),
                    PartnerSkill3 = table.Column<short>(nullable: false),
                    SkillRank1 = table.Column<byte>(nullable: false),
                    SkillRank2 = table.Column<byte>(nullable: false),
                    SkillRank3 = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterId = table.Column<long>(nullable: true),
                    Timestamp = table.Column<DateTime>(nullable: false),
                    VipPack = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogVip", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_LogVip_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LogVip_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemVNum = table.Column<short>(nullable: false),
                    MapNpcId = table.Column<int>(nullable: false),
                    ProduceItemVNum = table.Column<short>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MapTypeMap", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterHome_CharacterId",
                table: "CharacterHome",
                column: "CharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogVip_AccountId",
                table: "LogVip",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_LogVip_CharacterId",
                table: "LogVip",
                column: "CharacterId");
