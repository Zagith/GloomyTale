...
namespace GloomyTale.Communication.RPC
{
    public class MasterCommunicator : ICommunicationService
    {
        ...
        public int? RegisterWorldServer(SerializableWorldServer worldServer, ICommunicationClientEndPoint endpoint) {
            return _proxy.RegisterWorldServer(new RegisterWorldServerRequest
            {
