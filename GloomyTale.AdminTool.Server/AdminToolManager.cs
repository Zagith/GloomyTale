...
{
    internal class AdminToolManager
    {
        #region Members

        private static AdminToolManager _instance;
        ...
        public static AdminToolManager Instance => _instance ?? (_instance = new AdminToolManager());
