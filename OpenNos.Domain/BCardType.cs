...
namespace OpenNos.Domain
{
    ...
    public static class AdditionalTypes
    {
        ...
        {
            AttackHitChance100 = 11,
            AttackHitChance100Negated = 12,
            AttackHitChance = 11,
        ...
        {
            EternalIce = 11,
            EternalIceNegated = 12,
            GlacerusSkill = 21,
            GlacerusSkillNegated = 22
        }
        ...
        public enum PixieCostumeWings : byte
        {
